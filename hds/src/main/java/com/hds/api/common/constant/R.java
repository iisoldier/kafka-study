...
public final class R {
	...
	* @date 创建时间：2016年4月17日 下午7:44:02
	...
	public interface APIConstant{
		...
		//------------------API接口列表 ------------------------------
		public static final String API_SYS_Reload_Cache = "SYS_ReloadCache";
		//CCS-GetCCSDemo
		...
		//CCS_GetFenrunJour
		public static final String API_CCS_GetFenrunJour = "CCS_GetFenrunJour";
		//CCS_GetFenrunJour
		public static final String API_CCS_GetFeeJour = "CCS_GetFeeJour";
		//CCS_GetFeeJourDetail
		public static final String API_CCS_GetFeeJourDetail = "CCS_GetFeeJourDetail";
		//CCS_GetFenrunJourRealDetail
		public static final String API_CCS_GetFenrunJourRealDetail = "CCS_GetFenrunJourRealDetail";
   ...
   * @date 创建时间：2016年4月17日 下午4:04:28
    */
	public interface SystemConstant {
		...
		//request 校验反馈
		public static final String RESTYPE_FREQUENCY="VALID_FREQUENCY";
		//查询校验反馈
		public static final String RESTYPE_HANDLE="QUERY_HANDLE";

		//查询校验反馈
		public static final String RESTYPE_OTS_SERVICE="OTS_SERVICE";
		//查询校验反馈
		public static final String RESTYPE_OTS_CLIENT="OTS_CLIENT";
	...
	* @date 创建时间：2016年4月21日 下午9:56:50
	 */
		public enum APIEnum {			
			...
			CCS_GetFeeSettleOrder("CCS_GetFeeSettleOrder","费用划付指令查询接口"),
			CCS_GetFenrunJour("CCS_GetFenrunJour","分润流水查询接口"),
			CCS_GetFeeJour("CCS_GetFeeJour","费用流水查询接口"),
			CCS_GetFeeJourDetail("CCS_GetFeeJourDetail","费用流水明细数据查询接口"),
			CCS_GetFenrunJourRealDetail("CCS_GetFenrunJourRealDetail","分润流水明细数据查询接口");
