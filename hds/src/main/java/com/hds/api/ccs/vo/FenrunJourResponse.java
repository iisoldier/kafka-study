...
/**
* @ClassName:com.hds.api.ccs.vo.FenrunJourResponse
* @Description:
* @author zengli
* @date 创建时间：2016年4月26日 下午4:30:11
 */
@JSONType(orders = { "request_id", "sysid", "responsetime", "request_param",
		"response_records", "reponse_result" })
public class FenrunJourResponse {
	private String request_id;
	private String sysid;
	private String responsetime;
	private FenrunJourRequest request_param;
	...
	public FenrunJourRequest getRequest_param() {
		return request_param;
	}
	public void setRequest_param(FenrunJourRequest request_param) {
