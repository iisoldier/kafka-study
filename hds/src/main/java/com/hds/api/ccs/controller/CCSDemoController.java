...
public class CCSDemoController {
	...
	private static Logger logger = Logger.getLogger(CCSDemoController.class.getName());
	...
	* @return  CCSDemoRequestVo
	...
	@Frequency(name=AuthValidation.APIConstant.API_CCS_GETCCSDEMO,limit=1,time=3)
