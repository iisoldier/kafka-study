...
public class FenrunJourRealDetailRequest {
	// 系统编号
	private String sysid;
	// startpk
	private String s_fenrun_fee_sn;
	private String s_core_trade_date;
	private String s_core_taker_code;
	private String s_fee_category1;
	private String s_fee_category2;
	// endpk
	private String e_fenrun_fee_sn;
	private String e_core_trade_date;
	private String e_core_taker_code;
	...
	//------------------------------S_fenrun_fee_sn -------------------------------
	@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
	public String getS_fenrun_fee_sn() {
		return s_fenrun_fee_sn;
	}
	public void setS_fenrun_fee_sn(String s_fenrun_fee_sn) {
		this.s_fenrun_fee_sn = s_fenrun_fee_sn;
	}

	//-------------------------------S_core_trade_date  ------------------------------
	@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
	@DateStrValidator(isDateStr = true, message = RequestValidation.ValidateMessage.PRARM_ISDATESTR_ERRMSG)
	public String getS_core_trade_date() {
		return s_core_trade_date;
	}
	public void setS_core_trade_date(String s_core_trade_date) {
		this.s_core_trade_date = s_core_trade_date;
	}

	//-------------------------------S_core_taker_code  ------------------------------
	@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
	public String getS_core_taker_code() {
		return s_core_taker_code;
	}
	public void setS_core_taker_code(String s_core_taker_code) {
		this.s_core_taker_code = s_core_taker_code;
	}
	...
	//-------------------------------E_fenrun_fee_sn-----------------------------
	@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
	public String getE_fenrun_fee_sn() {
		return e_fenrun_fee_sn;
	}
	public void setE_fenrun_fee_sn(String e_fenrun_fee_sn) {
		this.e_fenrun_fee_sn = e_fenrun_fee_sn;
	}

	//-------------------------------E_core_trade_date-----------------------------
	@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
	@DateStrValidator(isDateStr = true, message = RequestValidation.ValidateMessage.PRARM_ISDATESTR_ERRMSG)
	public String getE_core_trade_date() {
		return e_core_trade_date;
	}
	public void setE_core_trade_date(String e_core_trade_date) {
		this.e_core_trade_date = e_core_trade_date;
	}

	//-------------------------------E_core_taker_code-----------------------------
	@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
	public String getE_core_taker_code() {
		return e_core_taker_code;
	}
	public void setE_core_taker_code(String e_core_taker_code) {
		this.e_core_taker_code = e_core_taker_code;
	}
	...
	public String toString() {
		...
		String str = "FeeSettleOrderRequest[sysid=" + sysid + ",s_fenrun_fee_sn="
				+ s_fenrun_fee_sn + ",s_core_trade_date=" + s_core_trade_date + ",s_core_taker_code="
				+ s_core_taker_code + ",s_fee_category1=" + s_fee_category1
				+ ",s_fee_category2=" + s_fee_category2 + ",e_fenrun_fee_sn="
				+ e_fenrun_fee_sn + ",e_core_trade_date=" + e_core_trade_date + ",e_core_taker_code="
				+ e_core_taker_code + ",e_fee_category1=" + e_fee_category1
				+ ",e_fee_category2=" + e_fee_category2
				// +",o_cols="+o_cols
