...
public class FeeSettleOrderRequest {
	...
	//S_deal_state------------------------------------------------------------------------------------------------
	@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
	@Length(max = RequestValidation.Constant.CCS_DEALSTATE_MAX, 
	         min = RequestValidation.Constant.CCS_DEALSTATE_MIN, 
	         message = RequestValidation.ValidateMessage.PARAM_DEALSTATE_LENGTH_ERRMSG)
