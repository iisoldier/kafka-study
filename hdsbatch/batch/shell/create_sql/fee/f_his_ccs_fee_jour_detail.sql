...
drop table if exists f_his_ccs_fee_jour_detail;
create table if not exists f_his_ccs_fee_jour_detail(
fee_sn           string   ,
fee_id           string   ,
fee_name         string   ,
