	...
	select
		...
		case when length(trim(fenrun_occur_date))==10 then concat(concat(substr(fenrun_occur_date,1,4),substr(fenrun_occur_date,6,2)),substr(fenrun_occur_date,9,2)) else fenrun_occur_date end,
