	...
	alter table  f_his_ccs_fenrun_jour_detail drop if     exists partition (dt = '$date_dt');
	alter table  f_his_ccs_fenrun_jour_detail add  if not exists partition (dt = '$date_dt');

	insert into table  f_his_ccs_fenrun_jour_detail partition( dt = '$date_dt' )
	select
