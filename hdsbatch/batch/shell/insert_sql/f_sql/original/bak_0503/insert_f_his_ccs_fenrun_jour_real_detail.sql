	...
	select
		...
		case when length(trim(fenrun_occur_date))==10 then concat(concat(substr(fenrun_occur_date,1,4),substr(fenrun_occur_date,6,2)),substr(fenrun_occur_date,9,2)) 
			when fenrun_occur_date is null then '' 
			else fenrun_occur_date end,
		...
		case when length(trim(process_trade_date))==10 then concat(concat(substr(process_trade_date,1,4),substr(process_trade_date,6,2)),substr(process_trade_date,9,2)) 
			when process_trade_date is null then '' 
			else process_trade_date end,
		process_trade_time      ,  
