...
/**
* @ClassName:com.hds.api.ccs.controller.CCSFeeSettleOrderController
* @Description: 指令划付接口控制器
* @author zengli
...
public class CCSFeeSettleOrderController {
	...
	private static Logger logger = Logger.getLogger(CCSFeeSettleOrderController.class);
	...
	* @return  FeeSettleOrderResponse
	...
	@Frequency(name=R.APIConstant.API_CCS_GetFeeSettleOrder,limit=1,time=3)
	public @ResponseBody FeeSettleOrderResponse getFeeSettleOrder(HttpServletRequest request,
		...
		logger.info(request_id+R.SystemConstant.LOG_OBJECT_DELIMITER+ 
				    ...
				    R.APIConstant.API_CCS_GetFeeSettleOrder
