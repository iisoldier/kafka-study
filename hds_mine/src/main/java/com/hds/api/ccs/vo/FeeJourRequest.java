...
/**
 * @ClassName:com.hds.api.ccs.vo.FeeJourRequest
 * @Description: 费用流水查询请求类
 * @author jinmeng
 * @date 创建时间：2016年4月27日 下午6:15:01
 */
...
public class FeeJourRequest {
	...
	public String toString() {
		...
		String str = "FeeJourRequest[sysid=" + sysid + ",s_order_sn="
