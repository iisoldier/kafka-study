/** 
s* @ClassName:com.hds.api.ccs.vo
* @Description:
* @author zengli
* @date 创建时间：2016年4月27日 下午4:54:32
*/
...
/** 
 * @ClassName:com.hds.api.ccs.vo.FeeJourDetailRequest
 * @Description:费用流水明细表查询
 * @author zengli
 * @date 创建时间：2016年4月27日 下午4:54:32
 */
@JSONType(orders = { "sysid", "s_fee_sn", "s_trade_date", "s_taker_code",
		"s_fee_category1", "s_fee_category2", "e_fee_sn", "e_trade_date",
		"e_taker_code", "e_fee_category1", "e_fee_category2", "direction",
		"limit" }, ignores = { "request_id", "request_ip" })
public class FeeJourDetailRequest {

	// 系统编号
	private String sysid;
	// startpk
	private String s_fee_sn;
	private String s_trade_date;
	private String s_taker_code;
	private String s_fee_category1;
	private String s_fee_category2;
	// endpk
	private String e_fee_sn;
	private String e_trade_date;
	private String e_taker_code;
	...
	//-----------------------------  Sysid  --------------------------------
		...
		public String getS_trade_date() {
			return s_trade_date;
		}
		public void setS_trade_date(String s_trade_date) {
			this.s_trade_date = s_trade_date;
		}

		//-------------------------------S_taker_code  ------------------------------
		@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
		public String getS_taker_code() {
			return s_taker_code;
		}
		public void setS_taker_code(String s_taker_code) {
			this.s_taker_code = s_taker_code;
		}
		...
		@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
		@DateStrValidator(isDateStr = true, message = RequestValidation.ValidateMessage.PRARM_ISDATESTR_ERRMSG)
		public String getE_trade_date() {
			return e_trade_date;
		}
		public void setE_trade_date(String e_trade_date) {
			this.e_trade_date = e_trade_date;
		}

		//-------------------------------E_taker_code-----------------------------
		@NotNull(message = RequestValidation.ValidateMessage.PRARM_NOTNULL_ERRMSG)
		public String getE_taker_code() {
			return e_taker_code;
		}
		public void setE_taker_code(String e_taker_code) {
			this.e_taker_code = e_taker_code;
		}
		...
		public String toString() {
			...
			String str = "FeeSettleOrderRequest[sysid=" + sysid + ",s_order_sn="
					+ s_fee_sn + ",s_occur_date=" + s_trade_date + ",s_deal_state="
					+ s_taker_code + ",s_credit_org_code=" + s_fee_category1
					+ ",s_debit_org_code=" + s_fee_category2 + ",e_order_sn="
					+ e_fee_sn + ",e_occur_date=" + e_trade_date + ",e_deal_state="
					+ e_taker_code + ",e_credit_org_code=" + e_fee_category1
